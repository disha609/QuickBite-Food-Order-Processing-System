...
## Key Features
- **4 Microservices:** User Auth, Menu, Order, Access Control
- **Secure APIs:** JWT authentication for safe and stateless communication
- **Event-Driven:** Real-time order updates & notifications
